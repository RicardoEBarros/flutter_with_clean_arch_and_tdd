...
void main() {
  ...
  testWidgets('should present goalkeepers section', (tester) async {
    ...
    presenter.emitNextEventWith(
      goalkeepers: [
        NextEventPlayerViewModel(name: 'Ricardo', initials: anyString()),
  ...
  testWidgets('should present error message on load error', (tester) async {
    ...
    expect(find.descendant(of: find.byType(ElevatedButton), matching: find.text('RECARREGAR')), findsOneWidget);
  });
